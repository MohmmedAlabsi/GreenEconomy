...
class UserController extends Controller
{
 ...
 public function index(Request $request) { $this->authorize('viewAny', \App\Models\User::class); return UserResource::collection($this->service->search($request->only(['search','status','role_id','region_id']))); }
