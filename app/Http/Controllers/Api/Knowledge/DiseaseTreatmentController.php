...
use App\Http\Requests\Knowledge\StoreDiseaseTreatmentRequest;
use App\Http\Requests\Knowledge\UpdateDiseaseTreatmentRequest;

class DiseaseTreatmentController extends \App\Http\Controllers\Controller
{
