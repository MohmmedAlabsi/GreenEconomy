...
class FeasibilityRequestController extends Controller
{
 ...
 public function store(StoreFeasibilityRequest $request) { return response()->json(['message' => 'Feasibility request created successfully', 'data' => new FeasibilityRequestResource($this->service->createRequest($request->validated(), $request->user()->id))], 201); }
